...
TOKENS = [
    ...
    ('NEWLINE',   r'\n'),
    ('SKIP',      r'[ \t\r]+'),
    ('KEYWORD',   r'\b(let|define|taking|show|record|when|otherwise|repeat|times|for|in|and|or|not|true|false|nothing|try|catch|throw|error|map|import|from|expose|assert|fn|do)\b'),
