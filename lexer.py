...
TOKENS = [
    ...
    ('NEWLINE',   r'\n'),
    ('SKIP',      r'[ \t\r]+'),
    ('KEYWORD',   r'\b(let|define|taking|show|record|when|otherwise|repeat|times|for|in|and|or|not|true|false|nothing|try|catch|throw|map|import|from|expose|assert|fn|do|route|respond|serve|on|expects|GET|POST|PUT|PATCH|DELETE|HEAD|OPTIONS)\b'),
